...
def loaddata():
    ...
    データを読む関数
    """
    # test_data = np.load("../kadai/augmented_6/augmented_data_image.npy")
    test_data = np.load("../kadai/1_data/train_data.npy")
    return test_data
...
def accuracy(func_predict, test_data):
    ...
    if data_size<3000:
        ...
        print('Test accuracy:', error)        
        return
    # test_label = np.load("../kadai/augmented_6/augmented_data_label.npy")
    test_label = np.load("../kadai/1_data/train_label.npy")
